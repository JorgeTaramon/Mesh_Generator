...
The springmesh_2d_cylindrical_annulus folder contains:
- MESH_2D_SPRING_CYL.m (main script)
- mfiles_CYL_MESH. A folder that contains the routines for creating the mesh that are called by MESH_2D_SPRING_CYL.m
