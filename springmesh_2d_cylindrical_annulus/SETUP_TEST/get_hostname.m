...
if strfind(pwd,'/Users/joha/')==1
    hostname = 'snaefell';
elseif strfind(pwd,'/Users/jorge/Dropbox/GEOMAR/springmesh_2d-cylindrical (branch-jorge)')==1
    hostname = 'jorgeMAC';
elseif strfind(pwd,'C:\Users\Tara\Documents\Dropbox\GEOMAR\springmesh_2d-cylindrical (branch-jorge)')==1
