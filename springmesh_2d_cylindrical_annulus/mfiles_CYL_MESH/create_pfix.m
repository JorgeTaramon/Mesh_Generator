...
%
% Purpose:
% Create 4 fixed nodes at the boundary (closest boundary nodes to theta =
% 0, 90, 180 and 270 degrees) and then remove those nodes from pbnd. These 
% pfix nodes give stability to the mesh when solving Hooke's law.
%
% Input:
...
index = zeros(1,4); % pre-allocate memory
for i = 1:4
