...
subplot(3,1,1)
bar(MESH.iter,MESH.fraction_bnd1_changed,'BarWidth',1,'FaceColor',[0 0 1]);
hold on
bar(MESH.iter,MESH.net_change_bnd1,'BarWidth',1,'FaceColor',[.7 .9 .7]);
ylim([0 1])
legend('Fraction of changed bnd1 nodes','Net change of bnd1 nodes')
subplot(3,1,2)
bar(MESH.iter,MESH.fraction_bnd2_changed,'BarWidth',1,'FaceColor',[0 0 1]);
hold on
bar(MESH.iter,MESH.net_change_bnd2,'BarWidth',1,'FaceColor',[.7 .9 .7]);
ylim([0 1])
