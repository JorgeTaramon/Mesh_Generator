...
% Convert to spherical coordinates
GCOORD_SPH_c_rot                      = cartesian2spherical_rad(GCOORD_c_rot);
...
GCOORD_els_out_cone_cross_2pi_rot     = spherical2cartesian_rad(GCOORD_SPH_els_out_cone_cross_2pi_rot);
...
GCOORD_SPH_els_out_cone_cross_2pi     = cartesian2spherical_rad(GCOORD_els_out_cone_cross_2pi);
...
% Convert to Cartesian coordinates
GCOORD_els_in_cone_rot     = spherical2cartesian_rad(GCOORD_SPH_els_in_cone_rot);
...
% Convert to spherical coodinates
GCOORD_SPH_els_in_cone     = cartesian2spherical_rad(GCOORD_els_in_cone);
...
% Convert to Cartesian coordinates
GCOORD_curved               = spherical2cartesian_rad(GCOORD_SPH);
...
GCOORD_curved_no_rot               = spherical2cartesian_rad(GCOORD_SPH_no_rot);
...
GCOORD_curved_rot                  = spherical2cartesian_rad(GCOORD_SPH_rot);
