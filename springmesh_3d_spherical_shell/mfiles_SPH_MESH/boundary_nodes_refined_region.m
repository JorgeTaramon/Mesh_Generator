function MESH = boundary_nodes_refined_region(MESH,GUIDE_MESH,SETTINGS)
% Usage: MESH = boundary_nodes_refined_region(MESH,GUIDE_MESH,SETTINGS)
%
% Purpose:
...
MESH.pbnd_ref_face_bot = pfix_ref_face_bot;
MESH.pbnd_ref_face_1   = pfix_face_1;
MESH.pbnd_ref_face_2   = pfix_face_2;
MESH.pbnd_ref_face_3   = pfix_face_3;
MESH.pbnd_ref_face_4   = pfix_face_4;
GCOORD                 = [MESH.pfix;              ...
                          MESH.pbnd1;             ...
                          MESH.pbnd2;             ...
...
end % END OF FUNCTION boundary_nodes_refined_region