function plot_cumulative_percentage_q_factor(q,s,iter,SETTINGS)
% Usage: plot_cumulative_percentage_q_factor(q,s,iter,SETTINGS)
%
% Purpose:
...
legend('quality factor, q','tetrahedral shape, s','Location','NorthWest')
xlabel('quality factor')
ylabel('cumulative % of tetrahedra')
