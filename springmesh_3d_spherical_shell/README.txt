...
The springmesh_3d_spherical_shell folder contains:
- MESH_3D_SPRING_SPH.m (main script)
- mfiles_SPH_MESH. A folder that contains the routines for creating the mesh that are called by MESH_3D_SPRING_SPH.m
